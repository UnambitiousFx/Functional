...
public static class ResultHttpExtensions
{
    ...
    /// </returns>
    public static async ValueTask<IActionResult> ToActionResultAsync(
    ...
    /// </returns>
    public static async ValueTask<IActionResult> ToActionResultAsync<TValue>(
    ...
    /// </returns>
    public static async ValueTask<IActionResult> ToActionResultAsync<TValue, TDto>(
        this ValueTask<Result<TValue>> awaitableResult,
