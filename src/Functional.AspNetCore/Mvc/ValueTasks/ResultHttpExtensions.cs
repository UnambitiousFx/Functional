...
namespace UnambitiousFx.Functional.AspNetCore.Mvc.ValueTasks;

/// <summary>
///     Provides extension methods for converting <see cref="Result" /> and <see cref="ValueTask" /> of
///     <see cref="Result" />
...
{
    /// <summary>
    /// Provides extension methods for converting <see cref="ValueTask{TResult}" /> of <see cref="Result" />
    ...
    extension(ValueTask<Result> awaitableResult)
    {
        ...
        public async ValueTask<IActionResult> ToActionResultAsync(Func<IActionResult> httpMapper,
        ...
        public async ValueTask<IActionResult> ToActionResultAsync(IErrorHttpMapper? errorMapper = null)
        {
            var result = await awaitableResult;
        ...
        public async ValueTask<IActionResult> ToActionResultAsync<TDto>(Func<TDto> dtoMapper,
            IErrorHttpMapper? errorMapper = null)
        {
            var result = await awaitableResult;
        ...
        public async ValueTask<IActionResult> ToActionResultAsync<TValue>(Func<TValue> dtoMapper,
    ...
    /// <summary>
    /// Provides extension methods for efficiently converting <see cref="ValueTask{TResult}" /> of
    ...
    extension<TValue>(ValueTask<Result<TValue>> awaitableResult) where TValue : notnull
    {
        ...
        public async ValueTask<IActionResult> ToCreatedActionResultAsync(string actionName,
        ...
        /// <param name="errorMapper">Optional custom error mapper. Uses default if not provided.</param>
        /// <returns>An IActionResult representing the result.</returns>
        public async ValueTask<IActionResult> ToCreatedActionResultAsync<TDto>(string actionName,
        ...
        /// <param name="errorMapper">Optional custom error mapper. Uses default if not provided.</param>
        /// <returns>An IResult representing the result.</returns>
        public async ValueTask<IActionResult> ToActionResultAsync<TDto>(Func<TValue, TDto> dtoMapper,
            IErrorHttpMapper? errorMapper = null)
        {
            var result = await awaitableResult;
            return result.ToActionResult(dtoMapper, errorMapper);
        ...
        /// <returns>An IResult representing the result.</returns>
        public async ValueTask<IActionResult> ToActionResultAsync(IErrorHttpMapper? mapper = null)
        {
            var result = await awaitableResult;
