...
public static class ResultHttpExtensions
{
    ...
    /// </returns>
    public static async ValueTask<HttpResult> ToHttpResultAsync(
        this ValueTask<Result> awaitableResult,
    ...
    /// <summary>
    ///     Converts an awaitable <see cref="ValueTask{TResult}" /> of type <see cref="Result{TValue}" />
    ...
    /// </returns>
    public static async ValueTask<HttpResult> ToHttpResultAsync<TValue>(
    ...
    /// <summary>
    ///     Converts a <see cref="ValueTask{TResult}" /> representing an asynchronous operation result
    ...
    /// </param>
    /// <returns>
    ///     A <see cref="ValueTask{TResult}" /> that resolves to an <see cref="Microsoft.AspNetCore.Http.IResult" />
    ///     representing the HTTP response.
    /// </returns>
    public static async ValueTask<HttpResult> ToHttpResultAsync<TValue, TDto>(
        this ValueTask<Result<TValue>> awaitableResult,
    ...
    /// </returns>
    public static async ValueTask<HttpResult> ToCreatedHttpResultAsync<TValue>(
        this ValueTask<Result<TValue>> awaitableResult,
    ...
    /// <summary>
    ///     Converts a ValueTask of Result into an HTTP 201 Created response with a DTO payload and
    ///     location header.
    ...
    public static async ValueTask<HttpResult> ToCreatedHttpResultAsync<TValue, TDto>(
        this ValueTask<Result<TValue>> awaitableResult,
        Func<TValue, string> locationFactory,
        Func<TValue, TDto> dtoMapper,
        IErrorHttpMapper? errorMapper = null)
