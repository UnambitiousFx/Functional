...
namespace UnambitiousFx.Functional.AspNetCore.Http.ValueTasks;

/// <summary>
///     Provides extension methods for handling <see cref="Result" /> and <see cref="ValueTask" /> of
///     <see cref="Result" /> to produce HTTP-compliant responses using <see cref="Microsoft.AspNetCore.Http.IResult" />.
/// </summary>
public static class ResultHttpExtensions
{
    /// <summary>
    ///     Provides extension methods for converting <see cref="Result" /> and <see cref="ValueTask{T}" /> of
    ///     <see cref="Result" />
    ...
    extension(ValueTask<Result> awaitableResult)
    {
        ...
        public async ValueTask<HttpResult> ToHttpResultAsync(Func<HttpResult> httpMapper,
        ...
        /// <summary>
        ///     Converts a Result wrapped in a ValueTask to an IResult for minimal API endpoints.
        ...
        public async ValueTask<HttpResult> ToHttpResultAsync(IErrorHttpMapper? errorMapper = null)
        {
            var result = await awaitableResult;
        ...
        public async ValueTask<HttpResult> ToHttpResultAsync<TDto>(Func<TDto> dtoMapper,
            IErrorHttpMapper? errorMapper = null)
        {
            var result = await awaitableResult;
        ...
        public async ValueTask<HttpResult> ToHttpResultAsync<TValue>(Func<TValue> dtoMapper,
    ...
    /// <summary>
    ///     Provides extension methods for converting <see cref="ValueTask{T}" /> of <see cref="Result{TValue}" /> into
    ...
    extension<TValue>(ValueTask<Result<TValue>> awaitableResult) where TValue : notnull
    {
        ...
        public async ValueTask<HttpResult> ToHttpResultAsync<TDto>(Func<TValue, TDto> dtoMapper,
            IErrorHttpMapper? errorMapper = null)
        {
            var result = await awaitableResult;
            return result.ToHttpResult(dtoMapper, errorMapper);
        ...
        public async ValueTask<HttpResult> ToCreatedHttpResultAsync(Func<TValue, string> locationFactory,
            IErrorHttpMapper? errorMapper = null)
        {
            var result = await awaitableResult;
        ...
        public async ValueTask<HttpResult> ToCreatedHttpResultAsync<TDto>(Func<TValue, string> locationFactory,
        ...
        /// <summary>
        ///     Converts a <see cref="Result{TValue}" /> wrapped in a <see cref="ValueTask" /> into an <see cref="IResult" />
