...
internal sealed class TypedFailureHttpMapper<TFailure> : IFailureHttpMapper
    where TFailure : IFailure
{
    private readonly Func<TFailure, FailureHttpResponse?> _factory;
    ...
    internal TypedFailureHttpMapper(Func<TFailure, FailureHttpResponse?> factory)
    {
