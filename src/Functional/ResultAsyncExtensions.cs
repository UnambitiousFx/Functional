...
public static class ResultAsyncExtensions
{
    ...
    public static async ValueTask<Result<TIn>> Tap<TIn>(
        this ValueTask<Result<TIn>> resultTask,
        Action<TIn> tap)
        where TIn : notnull
    {
    ...
    public static async ValueTask<Result<TIn>> Ensure<TIn>(
        this ValueTask<Result<TIn>> resultTask,
    ...
    public static async ValueTask<Result<TIn>> Recover<TIn>(
        this ValueTask<Result<TIn>> resultTask,
    ...
    public static async ValueTask Switch<TIn>(
        this ValueTask<Result<TIn>> resultTask,
    ...
    public static ValueTask<Result<TOut>> Map<TIn, TOut>(
        ...
        where TOut : notnull
    {
        ...
        static async Task<Result<TOut>> MapCore(Task<Result<TIn>> resultTask, Func<TIn, TOut> map)
        {
            return (await resultTask).Map(map);
        }
    }

    public static ValueTask<Result<TOut>> Bind<TIn, TOut>(
        this Task<Result<TIn>> resultTask,
        Func<TIn, Result<TOut>> bind)
        where TIn : notnull
        where TOut : notnull
    {
        ...
        static async Task<Result<TOut>> BindCore(Task<Result<TIn>> resultTask, Func<TIn, Result<TOut>> bind)
        {
        ...
        where TOut : notnull
    {
        ...
        static async Task<Result<TOut>> BindCore(Task<Result<TIn>> resultTask, Func<TIn, ValueTask<Result<TOut>>> bind)
        {
            return await new ValueTask<Result<TIn>>(resultTask).Bind(bind);
        }
    }

    public static ValueTask<Result<TIn>> Tap<TIn>(
        this Task<Result<TIn>> resultTask,
        Action<TIn> tap)
        where TIn : notnull
    {
        ...
        static async Task<Result<TIn>> TapCore(Task<Result<TIn>> resultTask, Action<TIn> tap)
        {
        ...
        where TIn : notnull
    {
        ...
        static async Task<Result<TIn>> TapCore(Task<Result<TIn>> resultTask, Func<TIn, ValueTask> tap)
        {
            return await new ValueTask<Result<TIn>>(resultTask).Tap(tap);
        }
    }

    public static ValueTask<Result<TIn>> Ensure<TIn>(
        this Task<Result<TIn>> resultTask,
        Func<TIn, bool> predicate,
        Func<TIn, Failure> errorFactory)
        where TIn : notnull
    {
        ...
        static async Task<Result<TIn>> EnsureCore(
    ...
    public static ValueTask<Result<TIn>> Recover<TIn>(
        this Task<Result<TIn>> resultTask,
        Func<Failure, TIn> recover)
        where TIn : notnull
    {
        ...
        static async Task<Result<TIn>> RecoverCore(Task<Result<TIn>> resultTask, Func<Failure, TIn> recover)
        {
            return (await resultTask).Recover(recover);
        }
    }

    public static ValueTask Switch<TIn>(
        this Task<Result<TIn>> resultTask,
        Action<TIn> onSuccess,
        Action<Failure> onFailure)
        where TIn : notnull
    {
        ...
        static async Task SwitchCore(Task<Result<TIn>> resultTask, Action<TIn> onSuccess, Action<Failure> onFailure)
        {
