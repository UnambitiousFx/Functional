...
{
    /// <summary>
    ///     Ensures all items in a ValueTask-wrapped collection result satisfy the given predicate.
    /// </summary>
    ...
    public static async ValueTask<Result<TCollection>> EnsureAll<TCollection, TItem>(
    ...
    /// <summary>
    ///     Ensures all items in a ValueTask-wrapped collection result satisfy the given predicate with custom error factory.
    /// </summary>
    /// <typeparam name="TCollection">The collection type implementing IEnumerable&lt;TItem&gt;.</typeparam>
    /// <typeparam name="TItem">The item type in the collection.</typeparam>
    /// <param name="resultTask">The ValueTask-wrapped result instance.</param>
    ...
    public static async ValueTask<Result<TCollection>> EnsureAll<TCollection, TItem>(
        this ValueTask<Result<TCollection>> resultTask, Func<TItem, bool> predicate,
