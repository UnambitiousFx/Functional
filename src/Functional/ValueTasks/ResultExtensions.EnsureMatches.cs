...
{
    /// <summary>
    ///     Ensures a ValueTask-wrapped string result value matches the specified regular expression pattern.
    /// </summary>
    ...
    public static async ValueTask<Result<string>> EnsureMatches(this ValueTask<Result<string>> resultTask,
    ...
    /// <summary>
    ///     Ensures a ValueTask-wrapped string result value matches the specified Regex instance.
    /// </summary>
    /// <param name="resultTask">The ValueTask-wrapped result instance.</param>
    ...
    public static async ValueTask<Result<string>> EnsureMatches(this ValueTask<Result<string>> resultTask, Regex regex,
    ...
    /// <summary>
    ///     Ensures a ValueTask-wrapped string result value does not match the specified regular expression pattern.
    /// </summary>
    /// <param name="resultTask">The ValueTask-wrapped result instance.</param>
    ...
    public static async ValueTask<Result<string>> EnsureDoesNotMatch(this ValueTask<Result<string>> resultTask,
        string pattern, string? message = null, string? field = null)
    {
        var result = await resultTask;
