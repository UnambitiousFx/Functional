...
public static partial class ResultExtensions
{
    ...
    public static ValueTask<Result<TOut1>> TryAsync<TValue1, TOut1>(this Result<TValue1> result,
        Func<TValue1, ValueTask<TOut1>> func) where TValue1 : notnull where TOut1 : notnull
    {
    ...
    extension<TValue1>(ValueTask<Result<TValue1>> awaitableResult) where TValue1 : notnull
    {
        ...
        /// <returns>A task with the result of the operation.</returns>
        public async ValueTask<Result<TOut1>> TryAsync<TOut1>(Func<TValue1, TOut1> func) where TOut1 : notnull
        {
        ...
        /// <param name="func">The async function to execute.</param>
        /// <returns>A task with the result of the operation.</returns>
        public async ValueTask<Result<TOut1>> TryAsync<TOut1>(Func<TValue1, ValueTask<TOut1>> func)
            where TOut1 : notnull
        {
            var result = await awaitableResult.ConfigureAwait(false);
