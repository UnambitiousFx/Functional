...
{
    /// <summary>
    ///     Ensures a numeric ValueTask-wrapped result value is within the specified range (inclusive).
    /// </summary>
    ...
    public static async ValueTask<Result<T>> EnsureInRange<T>(this ValueTask<Result<T>> resultTask, T min, T max,
    ...
    /// <summary>
    ///     Ensures a numeric ValueTask-wrapped result value is greater than the specified minimum.
    /// </summary>
    /// <typeparam name="T">The result value type which must implement IComparable.</typeparam>
    /// <param name="resultTask">The ValueTask-wrapped result instance.</param>
    ...
    public static async ValueTask<Result<T>> EnsureGreaterThan<T>(this ValueTask<Result<T>> resultTask, T min,
        string? message = null, string? field = null)
        where T : notnull, IComparable<T>
    {
        var result = await resultTask;
    ...
    /// <summary>
    ///     Ensures a numeric ValueTask-wrapped result value is less than the specified maximum.
    /// </summary>
    /// <typeparam name="T">The result value type which must implement IComparable.</typeparam>
    /// <param name="resultTask">The ValueTask-wrapped result instance.</param>
    ...
    public static async ValueTask<Result<T>> EnsureLessThan<T>(this ValueTask<Result<T>> resultTask, T max,
        string? message = null, string? field = null)
        where T : notnull, IComparable<T>
    {
        var result = await resultTask;
