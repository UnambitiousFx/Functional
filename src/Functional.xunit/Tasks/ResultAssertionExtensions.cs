...
public static class ResultAssertionExtensions
{
    ...
    public static async Task<SuccessAssertion<TValue>> Success<TValue>(
        this Task<ResultAssertion<TValue>> awaitableAssertion)
        where TValue : notnull
    {
        var assertion = await awaitableAssertion;
        return assertion.Success();
    ...
    ///     action.
    /// </returns>
    public static async Task<SuccessAssertion<TValue>> And<TValue>(
        this Task<SuccessAssertion<TValue>> awaitableAssertion,
    ...
    /// </returns>
    public static async Task<SuccessAssertion<TOut>> Map<TValue, TOut>(
        this Task<SuccessAssertion<TValue>> awaitableAssertion,
    ...
    public static async Task<FailureAssertion> AndMessage(
        this Task<FailureAssertion> awaitableAssertion,
