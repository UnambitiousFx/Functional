...
1. **Clone the repository**
   ```bash
   git clone https://github.com/UnambitiousFx/Functional.git
   cd Functional
   ```
...
5. **Run benchmarks** (optional)
   ```bash
   dotnet run --project benchmarks/FunctionalBenchmark/FunctionalBenchmark.csproj -c Release
   ```
...
│   ├── Functional.Generators/   # Source generators for OneOf
│   ├── Functional.AspNetCore/   # ASP.NET Core integration
│   └── Functional.xunit/        # xUnit testing utilities
├── test/
│   ├── Functional.Tests/        # Core library tests
│   ├── Functional.AspNetCore.Tests/
│   └── Functional.xunit.Tests/
├── benchmarks/
│   └── FunctionalBenchmark/     # Performance benchmarks
...
dotnet test test/Functional.Tests/
...
```bash
cd benchmarks/FunctionalBenchmark
