...
/// <summary>
///     Tests for async Tap extension methods on Result using ValueTask.
/// </summary>
public sealed partial class ResultExtensions
{
    ...
    [Fact]
    public async Task TapAsync_WithValueTaskResultAndSyncAction_ExecutesSideEffect()
    {
        // Arrange (Given)
    ...
    [Fact]
    public async Task TapAsync_WithValueTaskResultFailure_DoesNotExecute()
    {
        // Arrange (Given)
    ...
    [Fact]
    public async Task TapAsync_WithValueTaskGenericResultAndSyncAction_ExecutesSideEffect()
    {
        // Arrange (Given)
    ...
    [Fact]
    public async Task TapAsync_WithValueTaskGenericResultFailure_DoesNotExecute()
    {
        // Arrange (Given)
