...
public sealed partial class ResultExtensions
{
    ...
    {
        // Arrange (Given)
        var awaitableResult = ValueTask.FromResult(Result.Success(new[] { 2, 4, 6 }));
    ...
    {
        // Arrange (Given)
        var awaitableResult = ValueTask.FromResult(Result.Success(new[] { 2, 3, 6 }));
    ...
    {
        // Arrange (Given)
        var awaitableResult = ValueTask.FromResult(Result.Success(new[] { 1, 3, 5 }));
