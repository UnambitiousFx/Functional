...
/// <summary>
///     Tests for async TapBoth extension methods on Result using ValueTask.
/// </summary>
public sealed partial class ResultExtensions
{
    ...
    [Fact]
    public async Task TapBothAsync_WithValueTaskResultAndSyncActions_ExecutesOnSuccess()
    {
        // Arrange (Given)
    ...
    [Fact]
    public async Task TapBothAsync_WithValueTaskResultFailure_ExecutesOnFailure()
    {
        // Arrange (Given)
    ...
    [Fact]
    public async Task TapBothAsync_WithValueTaskGenericResult_ExecutesOnSuccess()
    {
        // Arrange (Given)
    ...
    [Fact]
    public async Task TapBothAsync_WithValueTaskGenericResultFailure_ExecutesOnFailure()
    {
        // Arrange (Given)
