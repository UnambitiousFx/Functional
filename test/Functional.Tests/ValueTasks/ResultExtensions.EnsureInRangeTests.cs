...
public sealed partial class ResultExtensions
{
    ...
    {
        // Arrange (Given)
        var awaitableResult = ValueTask.FromResult(Result.Success(15));
    ...
    {
        // Arrange (Given)
        var awaitableResult = ValueTask.FromResult(Result.Success(10));
    ...
    {
        // Arrange (Given)
        var awaitableResult = ValueTask.FromResult(Result.Success(3));
