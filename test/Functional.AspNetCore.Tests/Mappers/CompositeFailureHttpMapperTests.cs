...
{
    [Fact(DisplayName = "GetFailureResponse returns status from first mapper that provides one")]
    public void GetErrorResponse_FirstMapperReturnsStatus_ReturnsFirstStatus()
    {
        ...
        mapper1.GetFailureResponse(error)
               .Returns(new FailureHttpResponse { StatusCode = 400 });

        var mapper2 = Substitute.For<IFailureHttpMapper>();
        mapper2.GetFailureResponse(error)
               .Returns(new FailureHttpResponse { StatusCode = 500 });

        var sut = new CompositeFailureHttpMapper(mapper1, mapper2);

        // Act (When)
        var response = sut.GetFailureResponse(error);
        ...
        mapper2.DidNotReceive()
               .GetFailureResponse(Arg.Any<IFailure>());
    }

    [Fact(DisplayName = "GetFailureResponse tries next mapper when first returns null")]
    public void GetErrorResponse_FirstMapperReturnsNull_TriesNextMapper()
    {
        ...
        var mapper1 = Substitute.For<IFailureHttpMapper>();
        mapper1.GetFailureResponse(error)
               .Returns((FailureHttpResponse?)null);
    ...
    [Fact(DisplayName = "GetFailureResponse returns null when all mappers return null")]
    ...
    [Fact(DisplayName = "GetFailureResponse returns body from first mapper that provides one")]
    public void GetErrorResponse_FirstMapperReturnsBody_ReturnsFirstBody()
    {
        ...
        var mapper1 = Substitute.For<IFailureHttpMapper>();
        mapper1.GetFailureResponse(error)
               .Returns(new FailureHttpResponse { StatusCode = 400, Body = expectedBody });

        var mapper2 = Substitute.For<IFailureHttpMapper>();
        mapper2.GetFailureResponse(error)
               .Returns(new FailureHttpResponse { StatusCode = 400, Body = new { error = "other_error" } });
    ...
    [Fact(DisplayName = "GetFailureResponse tries next mapper when first returns null for body")]
    ...
    [Fact(DisplayName = "GetFailureResponse returns null when all mappers return null for body")]
    ...
    public void Constructor_WithReadOnlyList_CreatesMapperCorrectly()
    {
        ...
        var                             mapper1 = Substitute.For<IFailureHttpMapper>();
        var                             mapper2 = Substitute.For<IFailureHttpMapper>();
        IReadOnlyList<IFailureHttpMapper> mappers = new[] { mapper1, mapper2 };

        // Act (When)
        var sut = new CompositeFailureHttpMapper(mappers);
    ...
    public void Constructor_ParamsArrayNull_ThrowsArgumentNullException()
    {
        ...
        Assert.Throws<ArgumentNullException>(() => new CompositeFailureHttpMapper(null!));
    }
    ...
    public void Constructor_ReadOnlyListNull_ThrowsArgumentNullException()
    {
        ...
        Assert.Throws<ArgumentNullException>(() =>
                                                 new CompositeFailureHttpMapper((IReadOnlyList<IFailureHttpMapper>)null!));
    }
}
