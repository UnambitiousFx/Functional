...
using UnambitiousFx.Functional.AspNetCore.Mvc.Tasks;
using UnambitiousFx.Functional.Errors;

namespace UnambitiousFx.Functional.AspNetCore.Tests.Extensions.Mvc.Tasks;
...
public class ResultHttpExtensionsAsyncTests
{
    ...
    [Fact(DisplayName = "ToActionResultAsync<T> returns OkObjectResult with value for successful Task<Result<T>>")]
    ...
    [Fact(DisplayName = "ToActionResultAsync<T> returns error for failed Task<Result<T>>")]
    ...
    [Fact(DisplayName = "ToHttpResultAsync with DTO mapper transforms value for Task<Result>")]
